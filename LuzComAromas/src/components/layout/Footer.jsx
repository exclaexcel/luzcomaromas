  ...
  return (
    <div style={{
      ...
      {status === 'success' ? (
        ...
        >
          <label htmlFor="newsletter-email" style={{ fontFamily: "'Raleway', sans-serif", fontSize: '0.65rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--text-muted)', marginBottom: '0.5rem' }}>
            Email
          </label>
          <input
            id="newsletter-email"
