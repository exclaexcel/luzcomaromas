...
const QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Movimento', collection: 'energia' },
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center', maxWidth: '400px' }}>
        ...
        >
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#C9A84A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 2c0 0-3 2-3 6c0 2 1 4 3 5c2-1 3-3 3-5c0-4-3-6-3-6z" />
            <path d="M12 13c-2 0-4 1-4 3c0 3 2 5 4 6c2-1 4-3 4-6c0-2-2-3-4-3z" />
          </svg>
        </div>
        <p
          style={{
