...
export default function WhatsAppButton() {
  ...
  const url = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Olá! Vim pelo site LuzComAromas e gostaria de saber mais sobre as velas. 🕯️')}`
  ...
  return (
    <a
      ...
      aria-label="Fala comigo no WhatsApp"
    >
      {hovered && (
        <span style={{
          background: '#1E1035',
          ...
          whiteSpace: 'nowrap',
          boxShadow: '0 4px 20px rgba(30,16,53,0.3)',
        }}>
          Fala comigo
        </span>
      )}
